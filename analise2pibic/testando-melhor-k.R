...
# head(rmse_cross)
# media_rmse3 <- rmse_cross
# media_rmse1 <-  as.data.frame(media_rmse3 %>%  rowMeans())
# media_rmse3 <- cbind(media_rmse3, media_rmse1)
# media_rmse3 <- media_rmse3 %>% rename(plp = V1, metodos = V2, oac = V3, loac = V4, logica = V5, es = V7, media_rmse = 'media_rmse3 %>% rowMeans()')
# head(media_rmse)
